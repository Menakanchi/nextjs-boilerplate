        ...
        <div className="max-w-md w-full bg-white rounded-3xl p-8 border border-slate-200 shadow-2xl space-y-6 text-center">
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-slate-600 leading-relaxed">
              Đăng ký thành công! Tài khoản Reviewer của bạn cần được Admin phê duyệt qua email trước khi đăng nhập.
            </p>
          </div>

          <div className="p-4 bg-amber-50/80 rounded-2xl border border-amber-200 text-left text-xs text-amber-900 space-y-1">
            <span className="font-bold block">Thông tin đã ghi nhận:</span>
            <p>Họ tên: <strong>{nameInput}</strong></p>
            <p>Email: <strong>{emailInput}</strong></p>
            <p>Vai trò: <strong>Reviewer (Thẩm định)</strong></p>
          </div>

          <Link
            href="/login"
            className="w-full py-3 bg-blue-600 hover:bg-blue-700 text-white font-bold text-xs rounded-xl shadow-lg shadow-blue-600/20 flex items-center justify-center gap-2 transition"
          >
            ...
            <div className="grid grid-cols-2 gap-3 text-xs">
              ...
              >
                ...
                <p className="text-[10px] text-slate-500 leading-normal">
                  Kích hoạt ngay. Vào Workspace tạo kịch bản.
                </p>
              </button>
              ...
              >
                ...
                <p className="text-[10px] text-slate-500 leading-normal">
                  Cần Admin duyệt email trước khi đăng nhập.
                </p>
              </button>
            </div>
          </div>
